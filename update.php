...
ob_end_flush();
flush();
$commands = array('git pull', '/bin/rm -rf output','mkdir output','touch output/empty output/.gitignore','git checkout output/.gitignore','pelican content -t themes/notmyidea/','/bin/rm -rf ../ugrads','cp -a output ../ugrads');
